...
function Edit() {
  ...
  const [anEmployee,setAnEmployee]=useState()//particular employeee details
  ...
  console.log(anEmployee);//particular employee
  ...
  return (
    ...
    <div className="container">
        <h3 className='text-center m-3'>Update Empolyee Details</h3>
        <div className="form">
